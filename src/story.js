...
(() => {
  ...
  "her_waiting": {
    ...
    "lines": [
      ...
      {
        "text": "마을에서 네 이야기를 들었던 친구와 가끔 연락했다. 그 친구는 2025년에 아직 여행을 오기 전인 너와 다시 알게 되었다고 했다. 네게 나는 아직 처음 보는 사람이었다."
      },
      {
        "flag": "free",
  ...
  "after_airport": {
    ...
    "lines": [
      ...
      {
        "flag": "free",
        "yes": "내 하루를 살라고 했던 말도 기억했다. 그 말 하나만으로 오늘이 정해진 것은 아니었다.",
        "no": "기다려 달라던 말도 기억했다. 하지만 그 말 하나가 지난 이 년을 대신해 주지는 못했다."
      },
      {
  ...
  "her_uncertain": {
    ...
    "lines": [
      {
        "text": "공항을 나와 산으로 돌아왔다. 마지막에 마주 보고 했던 인사는 믿고 싶었다."
      },
      {
        "flag": "rendezvous",
        "equals": "unspecified",
        "yes": "호수인지 산장인지, 우리는 끝내 정하지 않았다. 한쪽이 비어 있으면 다른 쪽으로 가면 된다고 생각했다.",
        "no": "약속한 곳으로 갔다. 하지만 돌아올 길의 단서와 언제까지 기다릴지는 함께 정리하지 못했다."
      },
      {
        "text": "한참을 기다리다 다른 길로 그를 찾아 나섰다. 조금만 더 남아 있을 이유를, 그때의 나는 알지 못했다."
      }
    ],
    "pov": "그녀",
    "next": "returned"
  ...
  "her_depart": {
    ...
    "lines": [
      ...
      {
        "text": "처음 만날 너를 보내는 일과, 다시 돌아올 너를 기다리는 일은 같은 선택이 아니었다."
      },
      {
  ...
  "returned_departure": {
    ...
    "lines": [
      ...
      {
        "text": "호수에는 아무도 없었다. 그 뒤에 도착한 것은 그녀가 친구에게 맡겨 둔 짧은 편지였다."
      },
      {
        "speaker": "편지",
      ...
      {
        "flag": "free",
        "yes": "네 하루를 살라고 말했을 때 이런 밤까지 생각한 것은 아니었다. 그래도 그 말을 거두고 싶지는 않았다.",
        "no": "기다려 달라는 말을 끝없이 붙들게 할 수는 없었다. 편지의 종이를 천천히 접었다."
      },
      {
        "speaker": "편지",
  ...
  "missed": {
    ...
    "lines": [
      ...
      {
        "text": "젖은 흙에 발자국이 남아 있었다. 내 것보다 작았다. 그 끝을 놓친 채 아침이 왔다."
      },
      {
        "text": "친구에게 연락해 내 소식을 전해 달라고 부탁했다. 오래된 연락처에는 연결되지 않았다."
      },
      {
        "flag": "recorded",
  ...
  "b_promise": {
    ...
    "lines": [
      {
        "text": "언제 길이 열릴지는 몰랐다. 다만 첫 폭풍우가 9월 29일 밤이었다는 것은 기억했다."
      },
      {
        "speaker": "친구",
        "text": "돌아가면 너는 내 번호를 알고 있잖아."
      },
      {
        "speaker": "나",
        "text": "응. 알고 있어."
      ...
      {
        "speaker": "친구",
        "text": "그럼 그때 처음으로, 둘 다 같은 일을 기억하며 통화할 수 있겠다."
      }
    ],
    "prompt": "기다리는 시간을 막연한 말로 남겨 둘까.",
    "choices": [
      {
        "id": "promise-together",
        "text": "돌아온 날짜를 확인하고 바로 연락할게. 그다음은 함께 정하자.",
  ...
  "b_promise_answer": {
    ...
    "lines": [
      {
        "flag": "bPromise",
        "yes": "우리는 내가 기억하는 2026년의 연락처를 확인했다. 친구는 자기 수첩에 돌아올 날짜와 함께 적었다.",
        "no": "친구는 잠깐 웃다가 시선을 돌렸다. “어떻게든”이라는 말에는 내가 해야 할 일이 하나도 없었다."
      },
      {
  ...
  "b_autumn_plan": {
    ...
    "lines": [
      ...
      {
        "flag": "bPromise",
        "yes": "친구가 수첩을 펼쳤다. 우리가 확인했던 날짜와 번호가 적혀 있었다.",
        "no": "여름에 제대로 대답하지 않은 말이 생각났다. 돌아간 다음 어떻게 하겠다는 말."
      },
      {
        "speaker": "친구",
  ...
  "b_autumn_answer": {
    ...
    "lines": [
      {
        "flag": "bPromise",
        "yes": "친구는 수첩을 덮었다. 돌아올 시간을 확신할 수는 없어도, 돌아오면 내가 먼저 할 일은 정해졌다.",
        "no": "우리는 끝내 자세한 말을 하지 않았다. 한동안 컵이 식어 가는 것만 바라보았다.",
        "memoryIf": {
          "flag": "bPromise",
          "equals": true,
          "id": "friend_plan"
  ...
  "b_storm": {
    ...
    "lines": [
      ...
      {
        "text": "휴대폰에 친구의 번호가 떠 있었다. 지금 전화하면, 친구는 나와 작별할 수 있었다."
      }
    ],
    "mood": "night",
    "prompt": "이 밤을 어떻게 건널까.",
    "choices": [
      {
        "id": "b-call",
        "text": "전화해서 기다린다. 마지막 인사는 얼굴을 보고 한다.",
        "next": "b_call",
        "set": {
          "departure": "call"
        }
  ...
  "b_call": {
    ...
    "lines": [
      {
        "text": "친구가 우산도 제대로 펴지 못한 채 달려왔다. 숨을 고른 뒤에야 내 얼굴을 보았다."
      },
      {
        "speaker": "친구",
        "text": "전화해 줘서 고마워."
      ...
      {
        "flag": "bCommitted",
        "yes": "나는 젖은 손을 잡았다. 좋아한다는 말을 이미 했어도, 이 순간에는 다시 해야 했다.",
        "no": "친구는 내 소매를 잠깐 잡았다가 놓았다. 친구로 남기로 한 대답을, 지금 뒤집어서 위로하고 싶지는 않았다."
      },
      {
        "speaker": "친구",
        "text": "2025년의 너는 나를 모르겠지. 그래도 오늘 네가 한 말은 내가 알아."
      },
      {
  ...
  "b_depart_message": {
    ...
    "lines": [
      {
        "text": "그때와 똑같은 비가 와. 터널에 가볼게. 돌아가면 연락할게. 그렇게 적고 전송했다.",
        "memory": "friend_message"
      },
      {
        "text": "읽었다는 표시가 뜨기 전에 걸음을 옮겼다. 늦으면 길이 닫힐 것 같았다."
      },
      {
        "text": "돌아가면 설명할 수 있다고 생각했다. 설명을 듣기 전까지 친구가 보내야 할 시간은 생각하지 않았다."
      }
    ],
    "next": "b_after_departure",
    "mood": "night"
    ...
    "lines": [
      {
        "flag": "departure",
        "equals": "message",
        "yes": "메시지를 읽고 전화했을 때는 연결되지 않았다. 젖은 터널 앞에서 혼자 마지막 인사를 했다.",
        "no": "너를 보내고 한참 뒤에야 걸음을 돌렸다. 집에 도착해서도 젖은 손끝이 차가웠다."
      },
      {
        "text": "아침이 되었다. 나는 전날 입었던 옷을 갈아입었다. 출근 시간은 평소와 같았다."
      },
      {
        "text": "휴대폰은 조용했다. 네가 도착할 날짜는 내게 아직 두 해 뒤였다."
      },
      {
        "flag": "bCommitted",
        "yes": "네가 좋아한다고 했던 말을 떠올렸다. 사랑을 들은 사람도 아침에는 혼자 밥을 먹어야 했다.",
        "no": "네가 친구로 남고 싶다고 했던 말을 떠올렸다. 받아들였다고 해서 바로 아무렇지 않아지는 것은 아니었다."
      },
      {
        "text": "첫눈이 쌓일 때까지 휴대폰은 조용했다. 기다리기만 하면 하루가 너무 길었다. 일을 하고, 다른 사람을 만나고, 집으로 돌아왔다.",
        "art": "b-alone"
      },
      {
  ...
  "b_friend_days": {
    ...
    "lines": [
      ...
      {
        "text": "이름을 묻지 않아서 다행이었다. 내가 아는 너와 지금의 너 사이에는 아직 여행 하나가 남아 있었다."
      },
      {
        "flag": "bCommitted",
  ...
  "b_friend_boundary": {
    ...
    "lines": [
      ...
      {
        "flag": "bPromise",
        "yes": "나는 네가 돌아오면 먼저 연락하겠다는 말을 기억했다. 그때의 너에게 물을 수 있는 말이었다.",
        "no": "네가 돌아온 뒤에는 묻기로 했다. 그때도 서로 원하는 것이 다르다면, 더는 대답을 미루지 않기로 했다."
      },
      {
  ...
  "b_lending": {
    ...
    "lines": [
      ...
      {
        "flag": "bCommitted",
        "yes": "다음에는 그 겨울의 대답을 기억하는 너와 마주 앉고 싶었다. 나는 컵을 내려놓고 웃었다.",
  ...
  "b_returned": {
    ...
    "lines": [
      ...
      {
        "text": "친구의 번호를 눌렀다. 늘 알고 있던 번호였다. 이번에는 내가 전화를 걸었다."
      }
    ],
    "next": {
      "route": "outcome",
  ...
  "b_return_call": {
    ...
    "lines": [
      ...
      {
        "text": "내일 도시로 돌아가 만나기로 했다. 비행기 시간과 카페 문 닫는 시간을 함께 확인했다. 처음으로 똑같은 현재의 약속이었다."
      }
    ],
    "next": "b_reunion"
  },
  ...
  "b_friend_call": {
    ...
    "lines": [
      ...
      {
        "text": "친구는 한참 뒤에 대답했다. 목소리가 조금 떨렸지만, 내 이름을 부르는 대신 천천히 숨을 골랐다."
      },
      {
        "flag": "bCommitted",
        "yes": "좋아한다는 말만으로는 내가 비워 둔 부분이 채워지지 않았다. 친구는 두 해 동안 그 빈칸과 살아왔다.",
        "no": "친구로 남고 싶다고 말했던 봄을 기억했다. 돌아왔다고 해서 그 대답이 저절로 사랑으로 바뀌지는 않았다."
      },
      {
        "speaker": "친구",
  ...
  "b_friend_end": {
    ...
    "lines": [
      ...
      {
        "flag": "bCommitted",
        "yes": "“좋아했던 건 사실이야.” 친구가 말했다. “그렇지만 지금은 친구로 만나고 싶어.” 나는 뒤늦게 온 마음을 받아 달라고 요구하지 않았다.",
        "no": "친구는 우리가 봄에 정했던 말을 다시 꺼냈다. 나는 같은 대답을 했고, 친구도 자기 마음을 다 이야기했다."
      },
      {
        "speaker": "친구",
  ...
  "friend_plan": {
    ...
    "date": "2024. 09. 29",
    "kind": "약속",
    "body": "돌아온 날짜를 확인한 뒤 먼저 연락하기. 알고 있는 번호로 전화를 걸어 함께 커피 마시기. 기다림의 길이를 혼자 정하지 않기."
  },
  "friend_message": {
    "title": "뒤늦게 도착한 말",
    "date": "2024. 09. 29",
    "kind": "메시지",
    "body": "그때와 똑같은 비가 와. 터널에 가볼게. 돌아가면 연락할게. 친구는 그가 떠난 뒤에야 읽었다."
  },
  "friend_year": {
    "title": "친구가 된 해",
    "date": "2025",
  ...
  "b_reunion": {
    ...
    "quote": "“오늘 다 못 하면\n내일도 들을게.”",
    "art": "b-reunion",
    "note": "현재의 마음을 고백하고, 돌아온 뒤의 약속과 마주한 작별을 함께 지켰습니다."
  },
  "b_friend": {
    "order": "07",
    "type": "main",
    ...
    "art": "b-friend-end",
    "note": "함께한 시간을 인정하고, 지금의 관계를 서로의 뜻으로 받아들였습니다."
  }
};
  function outcomeFor(flags) {
    if (flags.route === 'b') return flags.bCommitted === true && flags.bPromise === true && flags.departure === 'call' ? 'b_reunion' : 'b_friend';
